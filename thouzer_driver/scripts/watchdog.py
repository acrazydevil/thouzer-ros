...
class ThouzerWatchdog(object):
    ...
    def _callback_battery(self, msg):
        rospy.loginfo("Received battery message with voltage: {}".format(msg.voltage_v))
        # rospy.logerr("Received battery message with voltage: {}".format(msg.voltage_v))
...
if __name__ == '__main__':
    rospy.init_node('thouzer_watchdog')
