...
class TestThouzerDriverCommander(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mqttc.username_pw_set("SmartRobot", "SmartRobot")
        self.mqttc.connect('192.168.212.1', 1883, 60)
        self.mqttc.message_callback_add("0/THOUZER_HW/RMS-10B1-AAJ65/exec/cmd", self.mqtt_callback_exec_cmd)
        self.mqttc.subscribe("0/THOUZER_HW/RMS-10B1-AAJ65/exec/cmd")
    ...
    def _publish_thouzer_status(self, status):
        self.mqttc.publish("0/THOUZER_HW/RMS-10B1-AAJ65/status/app",
    ...
    def test_exec_cmd_publisher(self):
        ...
        self.assertEqual(msg.topic, "0/THOUZER_HW/RMS-10B1-AAJ65/exec/cmd")
